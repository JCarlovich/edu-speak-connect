-- Primero, eliminar las tablas existentes que dependen del enum
...
-- Recrear el enum para roles de usuario
CREATE TYPE public.user_role AS ENUM ('teacher', 'student');

-- Recrear tabla de perfiles de usuario
...
BEGIN
    ...
    -- Si es un estudiante, crear registro en tabla students  
